...
#ifndef __VROOMVROOM_UIBUTTON_STARTGAME_BUTTON
#define __VROOMVROOM_UIBUTTON_STARTGAME_BUTTON
...
protected:
public:
    StartGameButton(string textureName, int x, int y , int w, int h);
    StartGameButton(Texture* texture, int x, int y , int w, int h);
